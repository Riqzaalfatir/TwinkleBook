  ...
  return (
    <section className="relative w-full min-h-screen">
      ...
      <div className="relative z-20 flex flex-col items-center justify-between text-center">
        <div className="pt-[67.5px] flex flex-col items-center justify-center">
          <div>
            <motion.div
            variants={fadeUp}
            initial="hidden"
          ...
          <motion.h2
            ...
            viewport={{ once: true, amount: 0.3 }}
            transition={{ duration: 1.5, ease: "easeOut" }}
            className="font-kinfolk text-[34px] text-[#1B1C1D] uppercase pt-[19px]"
          >
            Thank You
          </motion.h2>
          ...
          <motion.p
            ...
            viewport={{ once: true, amount: 0.3 }}
            transition={{ duration: 1.5, ease: "easeOut" }}
            className="font-times-new-roman text-[14px] text-[#1B1C1D] leading-normal pt-[36.5px]"
          >
            Your presence and blessings have made this <br />
            celebration more meaningful, and we are grateful <br />
            to share it with you.
          </motion.p>
        </div>

        <div className="relative px-10 pb-[5.5px] text-center leading-none">
          <motion.div
            variants={fadeUp}
            initial="hidden"
            whileInView="show"
