        ...
        <div className="relative w-full bg-[url('/images/Atet-Halim/Hero/LayerKertas4.webp')] bg-no-repeat [background-size:100%_100%] lg:bg-[url('/images/Atet-Halim/Hero/ateskertas.webp')] lg:[background-size:100%_100%]">
          <div className="relative flex flex-col items-center text-center">
            ...
            <motion.h1
              ...
              className="font-athelas text-[9.23vw] lg:text-[3.83vw] text-[#402824] pt-[8.5vw] lg:pt-[2.55vw] leading-[10.26vw] max-w-[60vw] lg:leading-[3.9vw] lg:max-w-[45vw] break-words"
            >
            ...
            <motion.h1
              ...
              className="font-athelas text-[9.23vw] lg:text-[3.83vw] text-[#402824] pt-[4.7vw] lg:pt-[1.4vw] leading-[10.26vw] max-w-[60vw] lg:leading-[3.9vw] lg:max-w-[45vw] break-words"
            >
            ...
            <motion.p
              ...
              animate={start ? "show" : "hidden"}
              transition={{ duration: 2, ease: "easeOut", delay: 0.8 }}
              className="font-athelas text-[3.59vw] text-[#402824] pt-[8.5vw] lg:text-[1.45vw] lg:pt-[2.4vw] pb-[52.8vw] lg:pb-[14vw]"
            >
              {date}
            </motion.p>
          </div>
