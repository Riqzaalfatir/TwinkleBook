...
//               <h1 className="font-athelas text-[20px] lg:text-[32px] text-[#402824] pt-[16px] lg:pt-[25px] tracking-wide leading-[1.4] break-words max-w-[225px] lg:max-w-[350px]">
...
//               <h1 className="font-athelas text-[20px] lg:text-[32px] text-[#402824] pt-[0px] lg:pt-[7px] tracking-wide leading-[1.4] break-words max-w-[225px] lg:max-w-[350px">
