...
const Gallery = ({ data }: GalleryProps) => {
  ...
  // all-or-nothing: dipakai HANYA kalau API kasih tepat 10 item dan semuanya punya url
  const apiPhotos: string[] | null = useMemo(() => {
    if (!Array.isArray(rawGalleryData) || rawGalleryData.length !== REQUIRED_PHOTO_COUNT) {
      return null;
    }
