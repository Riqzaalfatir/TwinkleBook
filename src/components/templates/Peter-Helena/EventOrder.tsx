  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center justify-center text-center leading-none mt-[32.5px] lg:mt-[30px]">
        ...
        >
          {holyMatrimony?.addressName?.trim() ?? "Chapel St. Albertus Magnus Atma Jaya"}
        </motion.h2>
        <motion.p
          variants={fadeUp}
          initial="hidden"
        ...
        <motion.a
          ...
          viewport={{ once: true, amount: 0.3 }}
          transition={{ duration: 1.5, ease: "easeOut" }}
          href={buildMapsUrl(holyMatrimony, "https://maps.app.goo.gl/UQMb3zP8T1VqwneH9")}
          target="_blank"
        ...
        <motion.a
          ...
          viewport={{ once: true, amount: 0.3 }}
          transition={{ duration: 1.5, ease: "easeOut" }}
          href={buildMapsUrl(reception, "https://maps.app.goo.gl/7rba66o67yTGGZUy7")}
          target="_blank"
          rel="noopener noreferrer"
          className="group relative inline-block font-ovo text-[12px] lg:text-[12.15px] text-[#454545] mt-[18px] lg:mt-[16.5px] uppercase transition-colors duration-300 hover:text-[#430D0D]"
        >
        ...
        <div className="flex flex-col gap-y-[36px] lg:gap-y-[32.5px] mt-[30px] lg:mt-[31px]">
          <div className="flex items-center justify-center gap-[20px]">
            ...
            >
              {teapai ? formatTime(teapai.date) : "14.30 WIB"} <br /> {teapai?.addressName?.trim() ?? "Esquire Room"}
            </motion.span>
          </div>
          ...
          <div className="flex items-center justify-center gap-[20px]">
            ...
            >
              {reception ? formatTime(reception.date) : "18.30 WIB"} <br /> {reception?.addressName?.trim() ?? "Ballroom"}
            </motion.span>
          </div>
          ...
          <div className="flex items-center justify-center gap-[20px]">
            ...
            <motion.span
              ...
              className="w-[150px] lg:w-[150px] font-cinzel text-left text-[14px] lg:text-[14.18px] text-[#454545] leading-[16px]"
            >
              {afterParty ? formatTime(afterParty.date) : "21.30 WIB"} <br /> {afterParty?.addressName?.trim() ?? "Esquire Room"}
            </motion.span>
          </div>
        </div>
      </div>
...
//           viewport={{ once: true, amount: 0.3 }}
//           transition={{ duration: 1.5, ease: "easeOut" }}
//           href="https://maps.app.goo.gl/UQMb3zP8T1VqwneH9"
//           target="_blank"
//           rel="noopener noreferrer"
//           className="group relative inline-block font-ovo text-[12px] lg:text-[12.15px] text-[#454545] mt-[18px] lg:mt-[16.5px] uppercase transition-colors duration-300 hover:text-[#430D0D]"
//         >
...
//           viewport={{ once: true, amount: 0.3 }}
//           transition={{ duration: 1.5, ease: "easeOut" }}
//           href="https://maps.app.goo.gl/7rba66o67yTGGZUy7"
//           target="_blank"
//           rel="noopener noreferrer"
//           className="group relative inline-block font-ovo text-[12px] lg:text-[12.15px] text-[#454545] mt-[18px] lg:mt-[16.5px] uppercase transition-colors duration-300 hover:text-[#430D0D]"
//         >
...
//               viewport={{ once: true, amount: 0.3 }}
//               transition={{ duration: 1.5, ease: "easeOut" }}
//               className="w-[150px] lg:w-[200px] font-cinzel text-right font-bold text-[14px] lg:text-[14.18px] text-[#430D0D] leading-[16px] lg:leading-[18px]"
//             >
//               Teapai <br /> Ceremony
//             </motion.span>
//             <motion.span
...
//               viewport={{ once: true, amount: 0.3 }}
//               transition={{ duration: 1.5, ease: "easeOut" }}
//               className="w-[150px] lg:w-[200px] font-cinzel text-left text-[14px] lg:text-[14.18px] text-[#454545] leading-[16px]"
//             >
//               14.30 WIB <br /> Esquire Room
//             </motion.span>
//           </div>
