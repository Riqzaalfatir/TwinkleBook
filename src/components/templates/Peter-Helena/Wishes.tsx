      ...
      <div className="relative z-10 flex flex-col items-center justify-center">
        ...
        <div className="max-w-[286px] lg:w-[289.62px] w-full flex flex-col gap-[20px] lg:gap-[20.25px] mt-[38px] lg:mt-[35px]">
          ...
          <motion.button
            ...
            className="bg-[#EEDBCD]  rounded-[6px] h-[33px] lg:h-[33.42px] text-[12px] lg:text-[12.15px] font-cinzel uppercase flex items-center justify-center gap-[11.5px] lg:gap-[11.4px] text-[#3E0E2A] transition-colors duration-300 hover:bg-[#EBD6C6] disabled:opacity-60"
          >
            <Image
          ...
          >
            {listStatus === "loading" && (
              <p className="text-white text-center py-4 font-cinzel text-[13px]">
                Memuat ucapan...
              </p>
            )}
...
//     const newId = (
//       pesanList[0]?.id !== undefined && typeof pesanList[0].id === "string"
//         ? String(Date.now())
//         : Date.now()
//     ) as PesanItem["id"];
