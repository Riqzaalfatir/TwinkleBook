      ...
      <section id="rsvp" className="w-full bg-[#430D0D]">
        <div className="flex flex-col items-center justify-center leading-none pt-[19px] lg:pt-[18.5px] pb-[97.5px]">
          ...
          <motion.div
            ...
            transition={{ duration: 1.5, ease: "easeOut" }}
          >
            <SmartRsvpForm.SubmitButton className="flex items-center justify-center text-center font-cinzel text-[12px] lg:text-[12.15px] text-[#3E0E1C] w-[161px] h-[36px] lg:w-[163.04px] lg:h-[36.46px] bg-[#EEDBCD] rounded-[6px] mt-[25px] transition-colors duration-300 hover:bg-[#EBD6C6]" />
          </motion.div>
          <motion.p
            variants={fadeUp}
            initial="hidden"
...
// type AttendChoice = "attend" | "unable" | null;

// const Rsvp = () => {
//   const [selected, setSelected] = useState<AttendChoice>(null);
//   const [notifType, setNotifType] = useState<string>("");

//   const handleAttendClick = () => {
//     setSelected((prev) => (prev === "attend" ? null : "attend"));
//   };

//   const handleUnableClick = () => {
//     setSelected((prev) => (prev === "unable" ? null : "unable"));
//   };

//   const handleConfirmClick = () => {
//     if (selected === null) {
//       setNotifType("incomplete_rsvp");
//       return;
//     }
//     setNotifType("confirm_rsvp");
//   };

//   const handleFinalConfirm = () => {
//     console.log("RSVP submitted:", selected);
//     setNotifType(
//       selected === "attend"
...
//             className={selected === "attend" ? activeClass : inactiveClass}
//           >
//             ATTEND
//           </motion.button>
//           <motion.button
...
//             className={selected === "unable" ? activeClass : inactiveClass}
//           >
//             UNABLE TO <br /> ATTEND
//           </motion.button>
//         </div>
...
//           className="flex items-center justify-center text-center font-cinzel text-[12px] lg:text-[12.15px] text-[#3E0E1C] w-[161px] h-[36px] lg:w-[163.04px] lg:h-[36.46px] bg-[#EEDBCD] rounded-[6px] mt-[25px] transition-colors duration-300 hover:bg-[#EBD6C6]"
//         >
//           CONFIRM UNABLE <br />
//           TO ATTEND
//         </motion.button>
