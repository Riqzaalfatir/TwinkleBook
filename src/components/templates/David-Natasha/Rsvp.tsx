...
const Rsvp = () => {
  ...
  const activeClass =
    "flex items-center justify-center w-[36.15vw] h-[10.26vw] bg-[#021125] rounded-[1.54vw] font-cormorant-garamond text-[3.33vw] text-white";
  const inactiveClass =
    "flex items-center justify-center w-[36.15vw] h-[10.26vw] border border-[#021125] rounded-[1.54vw] font-cormorant-garamond text-[3.33vw] text-[#021125]";
  ...
  const handleFinalConfirm = (): void => {
    setModalType(
      attendStatus === 1 ? "rsvp_confirmed_hadir" : "rsvp_confirmed_tidak_hadir"
    );
  };
  ...
  return (
    <section id="rsvp" className="relative w-full  z-10">
      <Image
        ...
        width={450}
        height={450}
        className="absolute -top-[0vw] -left-[0vw] w-[84vw] h-auto pointer-events-none z-20"
      />
      <Image
        ...
        width={450}
        height={450}
        className="absolute -bottom-[56vw] -right-[0vw] w-[26vw] h-auto pointer-events-none z-20"
      />
      <div className="relative z-[15] flex flex-col items-center text-center leading-none pt-[25.4vw] pb-[15.38vw] px-[6.15vw]">
        <h1
        ...
        <p className="font-cormorant-garamond text-[3.85vw] text-[#021125] mt-[8.2vw]">
          Dear Mr./Mrs./Ms.
        </p>
        <p className="font-cormorant-garamond text-[3.85vw] text-[#021125] mt-[4.7vw]">
          [Guest Name]
        </p>
        <p className="font-cormorant-garamond text-[3.33vw] text-[#021125] mt-[8.46vw] leading-[5vw]">
          Kindly confirm your attendance before <br />
          [Due Date]
        </p>
        <div className="flex items-center justify-center gap-[5.13vw] mt-[8.3vw]">
          <button
            type="button"
        ...
        <p className="font-cormorant-garamond text-[3.33vw] text-[#021125] mt-[21.77vw]">
          Confirm Your RSVP
        </p>
        <button
          type="button"
          onClick={handleSubmitClick}
          className="flex items-center justify-center w-[41.28vw] h-[9.23vw] bg-[#021125] rounded-[1.54vw] font-cormorant-garamond text-[3.33vw] text-white mt-[6.8vw]"
        >
          CONFIRM UNABLE <br />
          TO ATTEND
        </button>
        <p className="font-cormorant-garamond text-[2.82vw] text-[#021125] mt-[8.7vw] leading-[3.8vw]">
  ...
  href="https://wa.me/6281998478131"
          ...
          className="flex items-center justify-center w-[41.28vw] lg:w-[14.53vw] h-[7.69vw] lg:h-[2.77vw] bg-[#12877B] rounded-[1.54vw] font-cormorant-garamond text-[3.33vw] lg:text-[1.06vw] text-white gap-[1.93vw] lg:gap-[0.66vw] mt-[7.8vw] lg:mt-[2.25vw]"
        >
          <Image
