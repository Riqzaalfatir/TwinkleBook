...
const Header = () => {
  ...
  return (
    <div
      className="fixed top-0 left-0 w-full z-[99] px-4 py-3 lg:left-2 lg:right-0 lg:w-[435px] lg:px-8 lg:pt-[35px]"
    ...
    >
      ...
      {!open && (
        <motion.button
          ...
          className="text-[#C3C3C3] text-[28px] lg:text-[51px]"
        >
          <FiMenu />
        </motion.button>
      )}
      ...
      <AnimatePresence mode="wait">
        {open && (
          <motion.div
            ...
            className="absolute top-[12px] left-[22px] lg:top-[43px] lg:left-[37px] bg-[#7B7B7B]/70 py-4 px-5 lg:pt-[59px] lg:px-[40px] text-white w-[255px] lg:w-[424px]"
          >
            {/* CLOSE X */}
            <motion.button
